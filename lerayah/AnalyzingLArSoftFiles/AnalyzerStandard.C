...
void AnalyzerStandard(){
  ...
  // Orig: ifstream myfile("list_of_standard_electrons.list");
  ifstream myfile("FileLists/list_of_low_energy_electrons_undoped.list");
  copy(istream_iterator<string>(myfile),
       istream_iterator<string>(),
       back_inserter(filenames));
 
  //We'll just check the first 25 files for now
  //Update (06/10) Check first 100 files for undoped LowE e- 
