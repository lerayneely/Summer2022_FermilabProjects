...
void AnalyzerDoped(){
  ...
  ifstream myfile("/sbnd/app/users/lerayah/Summer2022_FermilabProjects/lerayah/MakingThingsMoreSimple/FileLists/list_of_monoenergetic_2.5MeV_electrons_doped.list");
  copy(istream_iterator<string>(myfile),
       istream_iterator<string>(),
       back_inserter(filenames));
 
  //We'll just check the first 25 files for now
  //06/14: Now check first 1000 files 
  filenames.erase(filenames.begin()+2500,filenames.end());
