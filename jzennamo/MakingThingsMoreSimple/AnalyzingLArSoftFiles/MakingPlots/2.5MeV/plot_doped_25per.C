void plot_doped_25per(){ //Name of program

  gStyle->SetOptStat(0); // shuts off annyoing stats box
  TFile* def_f = new TFile("../../monoenergetic_2.5MeV_electrons_doped_25percent.root"); //loads the file we want
